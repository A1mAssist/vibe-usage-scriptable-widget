...
- 按工具或模型统计的 Top 来源，并显示 Token 与预估费用
...
设置页按数据、显示、更新分组，支持更换 API Key、切换语言/外观、调整统计天数、选择大号小组件底部列表按 Agent 客户端或模型排序，并提供诊断信息。
...
每次自动安装新版前，脚本会先备份当前脚本。设置页的更新分组里可以恢复最近的脚本备份。
